...
public class RequestHelpTest extends BaseTest {
    ...
    private SuccessHelpRequestPage successHelpRequestPage;
    ...
    public void requestHelpTest() {
        LOGGER.info("Fill fold with valid data.");
        ...
        successHelpRequestPage = supportPage.requestHelpForm.sendFormWithAutoCaptchaHandling();
